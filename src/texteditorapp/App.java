...
//ActionListener
//They are used with buttons or menu. So that whenever you click them it notifies the ActionEvent 
//which in turn invokes the actionPreformed(ActionEvent e) function to perform the specified task.

//ItemListeners
//These are used with checkboxes, radio buttons, combo boxes kinds of stuff.
//See what happens when you use ActionListener with combo box instead of item listener

//ChangeListener
//This is used with components like sliders, color choosers and spinners where you want the action to
//be performed according to the change in that component
...
public class App extends JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        find.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F, java.awt.event.InputEvent.ALT_DOWN_MASK));
        find.setText("Find");
        ...
        replace.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_H, java.awt.event.InputEvent.ALT_DOWN_MASK));
    ...
    private void fontColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fontColorActionPerformed
        Color fontC = JColorChooser.showDialog(null, "Change Font Color", initialForeground);
        if (fontC != null) {
    ...
    private void findActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findActionPerformed
        try {
            String v = JOptionPane.showInputDialog(rootPane, "Find:", "Find", JOptionPane.NO_OPTION);
            String s = TextArea.getText();
            int in = 0;
            in = s.indexOf(v);
            TextArea.setCaretPosition(in);
            TextArea.setSelectionStart(in);
            TextArea.setSelectionEnd(in + v.length());
    ...
    private void replaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_replaceActionPerformed
        ...
        JTextField rep = new JTextField(20);
        ...
        if (result == JOptionPane.OK_OPTION) {
            int in = 0;
            in = TextArea.getText().indexOf(fin.getText());
            TextArea.setCaretPosition(in);
            TextArea.setSelectionStart(in);
            TextArea.setSelectionEnd(in + fin.getText().length());
            TextArea.replaceSelection(rep.getText());
        }
